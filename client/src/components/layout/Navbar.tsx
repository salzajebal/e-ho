      ...
      <div className="flex items-center gap-1.5 lg:gap-3 shrink-0 ml-auto">
        ...
        {user && displayBalance !== null && (
          ...
          >
            ...
            <span className="hidden lg:inline text-xs text-primary/70">보유자산</span>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <div className="px-2 py-1.5 text-sm">
                ...
                <p className="text-xs text-muted-foreground">
                  보유자산: {Math.floor(parseFloat(user.balance)).toLocaleString()}원
                </p>
                {(user as any).grade && (
              ...
              {user ? (
                <div className="bg-primary/10 border border-primary/20 rounded-xl p-3 space-y-1">
                  ...
                  <div className="flex items-center gap-1.5 pt-1">
                    ...
                    <span className="text-xs text-primary/70">보유자산</span>
